...
class ServiceResolverDiamondGraphContractTest {
    @Test
    fun diamond_graph_places_shared_root_before_branches_and_leaf_after_both() {
        ...
        val result = ServiceDependencyResolver().resolve(
            listOf(
                service("assistant", setOf("memory", "knowledge")),
        ...
        assertTrue(ids.indexOf("knowledge") < ids.indexOf("assistant"))
    }
}
