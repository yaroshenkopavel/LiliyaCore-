 ...
 * converter. In that mode the identity records the reproducible source/converter chain rather than
 * claiming that the generated bytes came from the TwinSuns artifact repository.
 */
